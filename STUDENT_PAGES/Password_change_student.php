                ...
                <div class="col-md-2">
                    <div class="sidebar content-box" style="display: block;">
                        <ul class="nav">
                            ...
                            <li><a href="Tutorial_student.php"><i class="fa fa-file-text"></i> Tutorial</a></li>
                            ...
                            <div class="content-box-large box-with-header">
                                ...
                                <form class="form-horizontal" action="" method="post">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" required="true" name="previous"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="new" class="form-control" required="true"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="confirm" class="form-control" required="true"
