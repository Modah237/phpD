                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                ...
                                <ul>
                                    ...
                                    <li><a href="add_tutorial.php">Add
                                            Tutorial</a></li>

                                    <li><a href="manage_tutorial.php">Manage
                                            Tutorials</a></li>
                                </ul>
                            ...
                            <li class="submenu">
                                ...
                                <!-- Sub menu -->
                                <ul>
                                    <li><a href="add_discussion.php">Add
                                            Discussion</a></li>
                                    <li><a href="manage_discussion.php">Manage
                                            Discussions</a></li>
                                </ul>
                            </li>
                            ...
                            <li><a href="../Login.php"><i class="glyphicon glyphicon-log-out"></i> Logout</a>
                            </li>
                            ...
                            <div class="content-box-large box-with-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3"
                                        style="padding-left:50px;padding-right:50px;padding-top:20px;padding-bottom:20px;">
                                        <div class="thumbnail">
                                            <a href="https://elearningscript.com/demov9.2/index.php/Tutorial/view">
