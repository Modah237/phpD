...
<body>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="content-box-header">
                            <div class="panel-title">Add Teacher</div>
                        </div>

                        <div class="content-box-large box-with-header">
                            <form class="form-horizontal" action="FormatedData.php" method="post"
                                ...
                                <input type="hidden" id="action" name="action" value="Teacher">
                                <div class="form-group">
                                ...
                                <div class="form-group" id="class">
                                    ...
                                    <div class="col-md-10">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" onchange="check_class(this)">
                                                All </label>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label class="col-sm-6 control-label">Allow Discussion</label>
                                            <div class="col-sm-6">
                                                <select class="selectpicker" name="chat">
                                    ...
                                    <div class="col-sm-4 col-sm-offset-1">
                                        <div class="form-group">
                                            <label class="col-sm-6 control-label">Allow tutorial</label>
                                            <div class="col-sm-6">
                                                <select class="selectpicker" name="tutorial">
                                                    <option value="1">Yes</option>
                                                    <option value="0">No</option>
                                                </select>
                                            </div>
                                ...
                                <!--
                                <div class="form-group">
                                    <label class="col-md-2 control-label">Teacher Photo</label>
                                    <div class="col-md-10">
    ...
    <script src="/ADMIN_PAGES/Send_To_Server.js"></script>
